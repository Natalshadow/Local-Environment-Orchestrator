...
alacritty -t "Daily Checklist" -e python3 ~/Dev/autostart-prompter/bootPrompt.py &

# Open Reminders in a new terminal
alacritty -t "Reminders" -e ruby ~/Dev/BotReminder/bot_reminder.rb &
...
if ping -c 3 -W 2 192.168.1.5; then
    ...
    alacritty -t "Backup" -e python3 ~/Dev/Rsync/backup.py &
else
